...
Sell Pages/Posts through WooCommerce 2.6+ quickly and easily. Tested up to WooCommerce Version 3.4.5.

== Description ==
This plugin has been completely rewritten from the ground up!  With so many requests for different features I decided to develop out a
premium paid version of the plugin which includes several great new features.


= Requirements =
This plugin DOES require WooCommerce to be installed and active.  I have tested this with the latest version to date Version 3.4.5.
